...
class Server(db.Model):
    ...
    #one-to-many
    # 1. channels
    channels_server = db.relationship("Channel", back_populates="server_channels", cascade='all, delete-orphan')
    # 2. user
...
class Channel(db.Model):
    ...
    # 2.message
    messages_channel = db.relationship("Message", back_populates="channel_messages", cascade='all, delete-orphan')
...
class Message(db.Model):
    ...
    # 3. reaction
    reactions_message = db.relationship("Reaction", back_populates="message_reactions", cascade='all, delete-orphan')
